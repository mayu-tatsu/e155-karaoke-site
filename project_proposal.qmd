...
Note that any additional, basic resources (such as resistors, capacitors, etc.) needed will be taken from either the Engineering Stockroom or Digital Lab for free.
...
Overall, the team hopes to complete the vast majority of the project's tasks together, so as to receive an equal and wholistic learning experience.
...
### Riskiest Element
The riskiest element of the project will likely be integrating the aforementioned microphone decimation involving CIC and FIR filters; at the moment, the team does not know anything about this, nor how to implement it, so it is hard to assess both the amount and difficulty of the workload before actually diving into it.
Furthermore, the decimation will have to be done using the FPGA, which means that there is less library support in the case that any complicated software needs to be configured.
