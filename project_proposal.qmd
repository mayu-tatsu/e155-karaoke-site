...
|                            | Implement new decimation FPGA functionality       | 11/7/25  |
|                            | Detect all input notes accurately with microphone | 11/13/25 |
| *Midpoint report and demo* | Finish midpoint report and prepare demo           | 11/16/25 |
|                            | Synchronize LCD output notes/lyrics with song(s)  | 11/20/25 |
|                            | Polish off project's final appearance             | 11/27/25 |
